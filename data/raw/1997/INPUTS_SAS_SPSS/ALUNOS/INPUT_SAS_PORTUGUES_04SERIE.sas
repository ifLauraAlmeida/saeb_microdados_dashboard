DATA PORTUGUES_04SERIE; 
     ...
     INFILE 'D:\DADOS\ALUNOS\PORTUGUES_04SERIE.TXT' LRECL=550 MISSOVER;
     INPUT
...
@502	A042_001	8.			/* Voce achou o teste de Portugues: */
@510	A042_002	8.			/* Quanto tempo voce gasta para fazer as liçoes de casa de Portugues? */
@518	A042_003	8.			/* Voce gosta de ler? */
@526	A042_004	8.			/* O que voce mais gosta de ler? */
@534	A042_005	8.			/* Voce usa jornais e revistas para fazer suas liçoes de casa? */
@542	A042_006	8.			/* Seu professor passa leitura de livros como liçao de casa? */
;
run;
