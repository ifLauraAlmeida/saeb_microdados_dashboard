DATA MATEMATICA_04SERIE; 
     ...
     INFILE 'D:\DADOS\ALUNOS\MATEMATICA_04SERIE.TXT' LRECL=542 MISSOVER;
     INPUT
...
@502	A042_001	8.			/* Voce achou o teste de Matematica: */
@510	A042_002	8.			/* Quanto tempo voce gasta para fazer as liçoes de casa de Matematica? */
@518	A042_003	8.			/* Voce entende o que o(a) professor(a) ensina nas aulas de Matematica? */
@526	A042_004	8.			/* Voce usa o que aprendeu em Matematica na escola, no seu dia a dia? */
@534	A042_005	8.			/* Voce gosta de Matematica? */
;
run;
