DATA CIENCIAS_08SERIE; 

     INFILE 'D:\DADOS\ALUNOS\CIENCIAS_08SERIE.TXT' LRECL=590 MISSOVER;
     INPUT
...
@478	A082_001	8.			/* Voce achou o teste de Ciencias: */
@486	A082_002	8.			/* Quanto tempo voce gasta para fazer as liçoes de casa de Ciencias? */
@494	A082_003	8.			/* Voce usa jornais e revistas para fazer suas liçoes de casa? */
@502	A082_004	8.			/* O professor de Ciencias costuma passar leitura de livros e revistas como liçao de casa? */
@510	A082_005	8.			/* Quando voce tem duvidas em Ciencias a quem voce pede ajuda? */
@518	A082_006	8.			/* Voce gosta de Ciencias? */
@526	A082_007	8.			/* Da 5ª a 8ª serie, voce teve professor de Ciencias: */
@534	A082_008	8.			/* O seu desempenho em Ciencias e prejudicado quando voce falta ou chega atrasado a aula? */
@542	A082_009	8.			/* Aprender Ciencias ajuda voce a resolver os probelmas do seu dia a dia? */
@550	A082_010	8.			/* Voce acha que seu professor se esforça para que voce aprenda Ciencias? */
@558	A082_011	8.			/* As aulas de Ciencias ajudam voce a compreender melhor as outras disciplinas? */
@566	A082_012	8.			/* O seu professor de Ciencias costuma utilizar outros espaços alem da sala de aula para o ensino da materia? */
@574	A082_013	8.			/* Voce consegue entender tudo que seu professor de Ciencias ensina? */
@582	A082_014	8.			/* Como voce considera seu desempenho em Ciencias? */
;
run;
