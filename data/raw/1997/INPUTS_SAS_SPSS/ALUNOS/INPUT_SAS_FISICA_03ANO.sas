DATA FISICA_03ANO; 
     ...
     INFILE 'D:\DADOS\ALUNOS\FISICA_03ANO.TXT' LRECL=614 MISSOVER;
     INPUT
...
@502	A032_001	8.	/* Voce achou o teste de Fisica: */
@510	A032_002	8.	/* Quanto tempo voce gasta para fazer as liçoes de casa de Fisica? */
@518	A032_003	8.	/* Voce usa jornais e revistas para fazer suas liçoes de casa? */
@526	A032_004	8.	/* O professor de Fisica costuma passar leitura de livros e revistas como liçao de casa? */
@534	A032_005	8.	/* Quando voce tem duvidas em Fisica a quem voce pede ajuda? */
@542	A032_006	8.	/* Voce gosta de Fisica? */
@550	A032_007	8.	/* Da 1ª a 3ª serie, voce teve professor de Fisica: */
@558	A032_008	8.	/* O seu desempenho em Fisica e prejudicado quando voce falta ou chega atrasado a aula? */
@566	A032_009	8.	/* Aprender Fisica ajuda voce a resolver os probelmas do seu dia a dia? */
@574	A032_010	8.	/* Voce acha que seu professor se esforça para que voce aprenda Fisica? */
@582	A032_011	8.	/* As aulas de Fisica ajudam voce a compreender melhor as outras disciplinas? */
@590	A032_012	8.	/* O seu professor de Fisica costuma utilizar outros espaços alem da sala de aula para o ensino da materia? */
@598	A032_013	8.	/* Voce consegue entender tudo que seu professor de Fisica ensina? */
@606	A032_014	8.	/* Como voce considera seu desempenho em Fisica? */
;
run;
