DATA MATEMATICA_08SERIE; 
     ...
     INFILE 'D:\DADOS\ALUNOS\MATEMATICA_08SERIE.TXT' LRECL=971 MISSOVER;
     INPUT
...
@787	A082M001	8.	/*	Quando você começou a estudar?	*/
@795	A082M002	8.	/*	Desde a 5ª série, quantas vezes você já mudou de escola?	*/
@803	A082M003	8.	/*	Em que tipo de escola você já estudou?	*/
@811	A082M004	8.	/*	Você já foi reprovado?	*/
@819	A082M005	8.	/*	Você já abandonou a escola e voltou para a mesma série no ano seguinte?	*/
@827	A082M006	8.	/*	Você deixou de freqüentar a escola por algum tempo?	*/
@835	A082M007	8.	/*	Você faz a lição de casa de Matemática?	*/
@843	A082M008	8.	/*	Seu professor de Matemática corrige a lição de casa?	*/
@851	A082M009	8.	/*	Seu professor de Matemática corrige a lição de casa na sala de aula com os alunos?	*/
@859	A082M010	8.	/*	Você gosta de estudar Matemática?	*/
@867	A082M011	8.	/*	Na sua turma os alunos fazem barulho e desordem?	*/
@875	A082M012	8.	/*	Na sua turma os alunos prestam atenção no que os professores dizem?	*/
@883	A082M013	8.	/*	Na sua turma os alunos fazem o que os professores pedem?	*/
@891	A082M014	8.	/*	Na sua turma os professores têm que esperar muito para que os alunos fiquem quietos?	*/
@899	A082M015	8.	/*	Você brigou com algum professor este ano?	*/
@907	A082M016	8.	/*	Você tem muitos amigos na sua turma?	*/
@915	A082M017	8.	/*	Na sua turma, você se sente deixado de lado?	*/
@923	A082M018	8.	/*	Seu professor de Matemática dá importância ao que você diz?	*/
@931	A082M019	8.	/*	Seu professor de Matemática elogia ou dá presentes quando você tira boas notas	*/
@939	A082M020	8.	/*	Seu professor de Matemática dá uma força para você estudar mais quando NÃO tira notas boas?	*/
@947	A082M021	8.	/*	Quando você precisa de ajuda, o professor de Matemática está sempre pronto para lhe atender?	*/
@955	A082M022	8.	/*	Você acha que seu professor de Matemática pega no seu pé?	*/
@963	A082M023	8.	/*	Quando você falta às aulas, sua família é avisada?	*/
;
run;
