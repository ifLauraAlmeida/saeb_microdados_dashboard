DATA MATEMATICA_03ANO; 
     ...
     INFILE 'D:\DADOS\ALUNOS\MATEMATICA_03ANO.TXT' LRECL=971 MISSOVER;
     INPUT
...
@787	A112M001	8.	/*	Quando você começou a estudar?	*/
@795	A112M002	8.	/*	No Ensino Médio (antigo 2º grau), quantas vezes você já mudou de escola?	*/
@803	A112M003	8.	/*	Em que tipo de escola você já estudou?	*/
@811	A112M004	8.	/*	Você já foi reprovado?	*/
@819	A112M005	8.	/*	Você já abandonou a escola e voltou para a mesma série no ano seguinte?	*/
@827	A112M006	8.	/*	Você deixou de freqüentar a escola por algum tempo?	*/
@835	A112M007	8.	/*	Você concluiu o Ensino Fundamental (antigo 1º grau) no supletivo?	*/
@843	A112M008	8.	/*	Você faz a lição de casa de Matemática?	*/
@851	A112M009	8.	/*	Seu professor de Matemática corrige a lição de casa?	*/
@859	A112M010	8.	/*	Seu professor de Matemática corrige a lição de casa na sala de aula com os alunos?	*/
@867	A112M011	8.	/*	Você gosta de estudar Matemática?	*/
@875	A112M012	8.	/*	Na sua turma os alunos fazem barulho e desordem?	*/
@883	A112M013	8.	/*	Na sua turma os alunos prestam atenção no que os professores dizem?	*/
@891	A112M014	8.	/*	Na sua turma os alunos fazem o que os professores pedem?	*/
@899	A112M015	8.	/*	Na sua turma os professores têm que esperar muito para que os alunos fiquem quietos?	*/
@907	A112M016	8.	/*	Você brigou com algum professor este ano?	*/
@915	A112M017	8.	/*	Você tem muitos amigos na sua turma?	*/
@923	A112M018	8.	/*	Na sua turma, você se sente deixado de lado?	*/
@931	A112M019	8.	/*	Seu professor de Matemática dá importância ao que você diz?	*/
@939	A112M020	8.	/*	Seu professor de Matemática elogia ou dá presentes quando você tira boas notas	*/
@947	A112M021	8.	/*	Seu professor de Matemática dá uma força para você estudar mais quando NÃO tira notas boas?	*/
@955	A112M022	8.	/*	Quando você precisa de ajuda, o professor de Matemática está sempre pronto para lhe atender?	*/
@963	A112M023	8.	/*	Você acha que seu professor de Matemática pega no seu pé?	*/
;
run;
